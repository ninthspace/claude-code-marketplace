 ...
 * harness's job. What it seeds is dpm's own vocabulary, applied by the same `applySeeds` a
 * real project gets — so a test that passes against a term the seed does not carry fails
