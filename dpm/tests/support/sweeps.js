 ...
 * are properties of the *static* graph. A dynamic `await import()` is what `bin/dpm-mcp.js` uses
 ...
 * happens before the entry point's first line. A check reading only `bin/dpm-mcp.js` would pass on
