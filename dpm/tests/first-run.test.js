 ...
 * `bin/dpm-publish.js` exits, the tool returns the same record, the guard names the command. This
...
import { DUMP_PATH, PUBLISH_COMMAND } from '../src/guard/index.js';
...
test('the README names both first-run steps [unit]', () => {
  ...
  assert.match(readme, /dpm-publish\.js/,
