...
import { orderingOf, dumpRows } from '../src/dump/rows.js';
import { dumpableObjects } from '../src/dump/objects.js';
import { literal, number, text, blob } from '../src/dump/literal.js';
...
test('nothing in the pipeline consults a locale', (t) => {
  ...
  const offenders = javascriptFilesUnder(SOURCE)
