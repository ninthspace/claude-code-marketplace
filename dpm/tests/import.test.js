 ...
 * a dump was reachable only from inside a conflicted merge. `bin/dpm-import.js` is that sequence with
...
import { describe, guard, DUMP_PATH, IMPORT_COMMAND } from '../src/guard/index.js';
import { run } from '../src/import/main.js';
import { rebuild, RebuildError } from '../src/rebuild/index.js';
