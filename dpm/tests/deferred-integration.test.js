 ...
 *
 * So this file drives `bin/dpm-mcp.js` as a process and reads only what came back over stdout. No
...
import { MARKER_PATH } from '../src/sync/marker.js';
import { main } from '../src/server/index.js';
import { RPC_ERRORS } from '../src/server/rpc.js';
