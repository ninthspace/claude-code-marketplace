...
import { describe, merge } from '../src/merge/index.js';
import { collisions, documents, losersOf, numberScopes, renumber } from '../src/merge/numbers.js';
import { MergeError, snapshot } from '../src/merge/rows.js';
import { run } from '../src/merge/main.js';
import { allocateNumber } from '../src/numbering/allocate.js';
...
test('the merge leaves the tree clean by the guard’s own rules', (t) => {
  ...
  const guarded = runNode([join(import.meta.dirname, '..', 'bin', 'dpm-guard.js'), repo.root]);
