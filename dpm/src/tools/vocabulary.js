...
import { readByKey, updateByKey } from './crud.js';
 ...
 * @returns {object[]}
 */
function vocabularyTools(context, options) {
 ...
 * @returns {object[]}
 */
export function vocabularies(context) {
  return [
 ...
 * @returns {object[]}
 */
export function vocabularyJoins(context) {
  return [
    ...entityTools(context, {
