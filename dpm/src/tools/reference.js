...
import { documentsByIdentifier } from '../projection/naming.js';
import { readById } from './crud.js';
import { defineTool, ToolError } from './convention.js';
 ...
 * @returns {string}
 */
function existing(byIdentifier, kind) {
 ...
 * @returns {object[]}
 */
export function referenceTools({ db }) {
