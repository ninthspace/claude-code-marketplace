...
import { hashDump, readMarker, writeMarker } from '../sync/marker.js';
import { VERDICT, verdict } from '../sync/verdict.js';
...
export const COMMANDS = {
  publish: 'bin/dpm-publish.js',
  import: 'bin/dpm-import.js',
  merge: 'bin/dpm-merge.js',
};
 ...
 */
export function guard(db, { root = '.', adopt = writeMarker } = {}) {
