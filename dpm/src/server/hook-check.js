 ...
 *
 * @param {string} git The `.git` directory.
 * @returns {boolean}
 */
function hooksMoved(git) {
  try {
 ...
 *
 * @param {string} directory The directory holding the database — `.dpm/`, or wherever
 *   `DPM_DATABASE` put it.
 * @returns {string|null}
 */
export function unguardedMessage(directory) {
