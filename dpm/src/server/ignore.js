 ...
 *
 * @param {string} directory The directory holding the database — `.dpm/`, which the caller has
 *   already created.
 * @returns {boolean} Whether this call wrote it. `false` means one was already there and was left
 *   exactly as it was.
 */
export function writeIgnore(directory) {
