...
import { agentLabel, collection, detailOf, taxonomyLabel } from '../load.js';
import { field, heading, table } from '../text.js';
 ...
 * @returns {string}
 */
export function renderReview(db, tree, identifiers, where) {
