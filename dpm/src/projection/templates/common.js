...
import { bullet, field, heading, paragraph, render, table } from '../text.js';
 ...
 * @returns {string}
 */
export function metadata(document, ancestry, ref, identifiers) {
 ...
 * @returns {string[]}
 */
export function sections(rows, ref, level = 2) {
 ...
 * @returns {(string|null)[]}
 */
export function crossCutting(tree, ref, identifiers) {
 ...
 * @returns {string}
 */
export function document(tree, ref, identifiers, body) {
  return render([
