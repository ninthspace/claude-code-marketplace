 ...
 * @param {string} kind
 * @param {string|null} [parentId] NULL or omitted for a root-numbered kind.
 * @returns {number} The allocated value — 1 on the first call for that kind and parent.
 */
export function allocateNumber(db, kind, parentId = null) {
