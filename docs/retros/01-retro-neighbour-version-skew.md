...
**Retired 2026-09-02T09:52:00.000Z**: Promoted into "A must-NOT stated as an equality is a change detector, and a set comparison needs a floor" — the ENVX4 import equality is the section's first bullet, and its own sentence about a rejection wearing a change detector's clothes is the section's opening claim.
