...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCKGZXMKJCP8RCBKE93NT', '01M05JWZH4VAJACEP33M4S1P1C', 'fails something mechanically the next time one board moves and the other does not', '01M05PHTKQ9PQC4JJ7J91WKF2K', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCNK8Z0S0R0VBAFQ3P2DK', '01M05KAH8JWD17744XDY3S9PTN', 'the CPM board''s source is readable at `cpm/tools/board/` relative to the marketplace checkout root', '01M05PHXBVDTNHCT2R9M5AQR38', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCQP9AWQTZB7DWTHN4BRV', '01M05KARYFQ5C7K2APQ4MPKY35', 'the board must not require the CPM plugin to be installed or readable', '01M05PHYTVWQ4TEQHVJAH1VRK9', 0, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e', 'dpm:do', 'Epic 2 story 5 — the cross-board parity check', '{"test_command":"uv run pytest (from dpm/tools/board)","framework":"none (plain Python + Textual)","refactoring":{"epic2-story1":"ran — registry_wiring extracted to tests/support/wiring.py, shared by test_picker and test_keys","epic2-story2":"ran — toasts() extracted to tests/support/pilot.py, replacing two copies of reports() in test_degradation and test_ralph_selection; show_everything() added for the six tests whose fixtures now render filtered","epic2-story3":"ran — surveyed() and registered() moved from test_keys.py into tests/support/wiring.py, now shared with test_extras","epic2-story4":"ran — binding_tuples() extracted in key_maps.py so app_bindings and cpm_labels read one AST walk; footer() added to pilot.py"}}', NULL, '2026-08-16T14:14:23.386Z', '2026-08-16T18:21:36.135Z');
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05PHNRSGHHF8844AHMJ2E7M', '01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 5, 'The cross-board parity check', 'pending', NULL, 4, 0);
