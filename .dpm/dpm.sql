...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QC3NHBFPD4M0GVNFT7MBR', '01M05JW91578GQ942N25MEHN7Y', '`z` shows or hides retired work', '01M05P6MP4D0BTKCGC1RAW18Y2', 3, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QC51RKQDP73XK80NQR81M', '01M05JWBSBWAGG1996DS44GNY8', 'Retired work is hidden when the board opens and `z` toggles it', '01M05P6MP4D0BTKCGC1RAW18Y2', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QC6EVDWVWS1C7JQ6F3WK4', '01M05JWBSBWAGG1996DS44GNY8', 'Each press says which way it went', '01M05P6P3DP6TZ16WKYP6DPHP6', 1, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QC8FY53ZTAMZV22JNX3BN', '01M05JWBSBWAGG1996DS44GNY8', 'where retired means `complete` together with the two states `status_model.RETIRED` already names', '01M05P6QE53A3NEXH0EFAPRGDW', 2, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCANEXHEWJKPH96TRN138', '01M05JWBSBWAGG1996DS44GNY8', 'where retired means `complete` together with the two states `status_model.RETIRED` already names', '01M05P6SH405DXTD0CR73QECPD', 3, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e', 'dpm:spec', 'Complete — spec 2 broken down into 4 epics, 16 stories, 41 tasks, 51 coverage rows', '{"skill":"dpm:epics","spec":"01M05J7VD7PWH32KWMND9MGHMN","epics":["01M05NNYYBX6XYRMND1CN4M4TY","01M05NNZQE4VVEWMCXGMZ72YJ5","01M05NP14C3GCH372FM6NN2T5S","01M05NP15VPTJKBNK0B2HQ4XCZ"],"gap_check":"clear — every must-have, should-have and environmental requirement covered; FR10 and FR11 excluded; FR4''s affordance closed with a feature criterion on epic 3 story 1","unbound_criteria":"epic 2 story 5 carries three criteria warranted by AD2 rather than requirement text: fail-rather-than-skip, not-an-equality, and the plugin-cache rejection","integrity":"builds_on edge 01M05J88V2WYQPDEFCZJM1G89J (spec -> discussion) is not a pair that edge kind admits; created during the spec run and not removable with the tools available"}', NULL, '2026-08-16T14:14:23.386Z', '2026-08-16T17:01:05.068Z');
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05P6AZSWD3EZ6JY58YZ1SDG', '01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 2, 'Hide retired work', 'pending', NULL, 1, 0);
