...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCFCMHHNPQXP3WBWZ5RX9', '01M05JWTJ2VA95F698PF5AJ2JH', 'use the CPM board''s wording wherever the action is the same one', '01M05P6XMXNMW9RDD3A6NSZZ0T', 0, NULL, NULL);
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05P6D3M5WR5CRXGD2K1M9G6', '01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 4, 'Footer and palette wording', 'pending', NULL, 3, 0);
...
INSERT INTO "task" ("id", "story_id", "number", "title", "description", "status", "status_note", "position") VALUES ('01M05QA3381HABSS2BE5DM3XFB', '01M05P6D3M5WR5CRXGD2K1M9G6', 1, 'Align the footer labels with CPM''s wording', 'Only where the action is the same one — DPM-only capabilities keep their own labels, having nothing on the other board to match.', 'pending', NULL, 0);
