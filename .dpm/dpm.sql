...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCCNAEPYZHX76TJ6FN9W5', '01M05JWDT6D746WHHMYMX25W99', 'The forced re-read gives up `R` and takes `ctrl+r`; search and coverage gaps keep `ctrl+f` and `ctrl+g`.', '01M05P6TWQ1SWTGYGBQ90PGEQ0', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCE585A7QF7KXVJ59ZXQS', '01M05JWDT6D746WHHMYMX25W99', 'bound to a key that collides with nothing in the CPM map', '01M05P6W8R10VSEKPK1FHREG05', 1, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e', 'dpm:do', 'Epic 2 story 3 — DPM''s extras moved clear', '{"test_command":"uv run pytest (from dpm/tools/board)","framework":"none (plain Python + Textual)","refactoring":{"epic2-story1":"ran — registry_wiring extracted to tests/support/wiring.py, shared by test_picker and test_keys","epic2-story2":"ran — toasts() extracted to tests/support/pilot.py, replacing two copies of reports() in test_degradation and test_ralph_selection; show_everything() added for the six tests whose fixtures now render filtered"}}', NULL, '2026-08-16T14:14:23.386Z', '2026-08-16T18:09:16.221Z');
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05P6CEFYY4RZ2KYA6TG1ESC', '01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 3, 'DPM''s extras moved clear', 'pending', NULL, 2, 0);
