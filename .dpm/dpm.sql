...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05NXS69YA4RRWMKE80NGWEZ', '01M05KAB1GYPQKYV0AT1ZFCB5P', '`uv run pytest` from `dpm/tools/board` runs the suite, with pytest 8 or later, pytest-asyncio 0.24 or later', '01M05NTQ1XYYJF2Q29Y5H819C1', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05NXTJEANHJJZ106595MHRT', '01M05KADV6YVN6NAZHT48PRCQH', 'the dependency list in `pyproject.toml` and the PEP 723 inline block at the top of `board.py` naming the same packages', '01M05NTRQ3K4YGTV51SAYFRJYR', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05NXVYRQG73BT23BTXNM41Y', '01M05KAF6BY0J9X2GN020JK71N', 'a markdown renderer importable from a package the board already declares', '01M05NTS6XA6A5HSPGW14CJYCK', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05NXXBANM45JP4MBNNQKTYM', '01M05KAKAN0ECNYACZGVVBX2QM', 'the suite must not require network access', '01M05NTTG64NGCBJWCF0Q4G3YZ', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05NXYQ8P8AZB1P7XGW4XJQ8', '01M05KAND02WHYZQQRD2C2SFX2', 'must not require a package outside `board.py`''s inline block', '01M05NTVWFT97H2KN1MFYBHK5H', 0, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e-do-e1', 'dpm:do', 'Epic 1, story 2 — The environment this work rests on', '{"test_command":"uv run pytest, from dpm/tools/board","framework":"none detected (PEP 723 single-file scripts, pytest 8 + pytest-asyncio, asyncio_mode=auto)","retro_gate":{"applied":3,"deferred":4},"stories":{"01M05NTFP3SP5G00T656J93QFX":{"title":"A fixture project holding every state","outcome":"complete","refactor":"ran — the consolidation was `statuses()` in fixture_database.py, which replaced a literal status set in test_client.py and is the fourth of the module''s role-based helpers; suite re-run green (257 passed)","notes":"fixture already existed; extended rather than built. Baseline carried one unrelated failure (test_states.py pointed at docs/specifications/48-spec-dpm-board.md, moved to docs/cpm/) — fixed. Two tests transcribed the fixture''s shape and were re-derived."}}}', NULL, '2026-08-16T17:21:26.993Z', '2026-08-16T17:35:38.657Z');
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05NTGKBR1C512G581KVZH52', '01M05NNYYBX6XYRMND1CN4M4TY', 'epic', 2, 'The environment this work rests on', 'pending', NULL, 1, 0);
