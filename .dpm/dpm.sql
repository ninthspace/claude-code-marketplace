...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QPFBW7X45GNTYAMMSZ3MH', '01M05JWFWE9YFDG4F6TZYEW28Q', 'renders as a muted bar in the row''s own colour, blended partway toward the background', '01M05QKA637JGDE7NZNP4TMHKA', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QPGRFMY0PE8NVQQFVERZB', '01M05JWFWE9YFDG4F6TZYEW28Q', 'Textual''s default highlight block does not show through it.', '01M05QKBM8KWJTV6FXEFK1WDWQ', 1, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QPJW7EMZF9NNJ0C8WQBEW', '01M05JWFWE9YFDG4F6TZYEW28Q', 'Textual''s default highlight block does not show through it.', '01M05QKDNKTTPPAQNE1HMBGTWT', 2, NULL, NULL);
...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05R9F3A1T3RPYSJVC0KF5N0', '01M05JWFWE9YFDG4F6TZYEW28Q', 'The highlighted row renders as a muted bar in the row''s own colour', '01M05R99VD3D4QC4TX5HCMWJMV', 3, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e', 'dpm:do', 'Epic 2 complete — moving to epic 3, the rendered row', '{"test_command":"uv run pytest (from dpm/tools/board)","framework":"none (plain Python + Textual)","refactoring":{"epic2-story1":"ran — registry_wiring extracted to tests/support/wiring.py","epic2-story2":"ran — toasts() extracted to pilot.py; show_everything() added","epic2-story3":"ran — surveyed() and registered() moved into wiring.py","epic2-story4":"ran — binding_tuples() extracted in key_maps.py; footer() added to pilot.py","epic2-story5":"ran — disagreement_report() extracted; readable() gates every source read","epic2-story6":"skipped — no implementation task touched code; the story''s whole output is a recorded comparison"}}', NULL, '2026-08-16T14:14:23.386Z', '2026-08-16T18:33:19.992Z');
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e-ralph', 'dpm:ralph', 'Iteration 3 — epic 2', '{"harness_session_id":"d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e","note":"The harness session id already keys the dpm:spec/dpm:epics row for this conversation, so this run''s row is keyed on a derived id. The state file carries the harness id — that is what the stop hook matches.","mode":"epic","argument":"epics 1-4","epics":["01M05NNYYBX6XYRMND1CN4M4TY","01M05NNZQE4VVEWMCXGMZ72YJ5","01M05NP14C3GCH372FM6NN2T5S","01M05NP15VPTJKBNK0B2HQ4XCZ"],"max_iterations":50,"completion_promise":"ALL_EPICS_COMPLETE","hook":"ralph-loop@ninthspace-ralph 1.2.1, the only enabled Stop hook; ralph-wiggum@claude-code-plugins and ralph-loop@claude-plugins-official are installed and disabled","probe":"dpm 0.5.0 ships no hooks/lib/ralph-hook-probe.sh, so the skill''s probe could not be run; substituted the plugin''s own tests/test-fail-closed.sh, which passed 10/10 including a turn ending on a tool call keeping the loop alive","plan_flags_cleared":["01M05PHNRSGHHF8844AHMJ2E7M","01M05QSAPA8MP912VBFV9M9GEX"],"gitignore":"added .claude/ralph-loop.local.md","launch_commit":"b18a6c1","entry_numbering":"entries carry the stop hook''s iteration counter, so iteration 1 (the arming turn, which did no work) has no entry","iterations":[{"iteration":2,"counts":{"stories_complete":0,"stories_total":16,"coverage_verified":0,"coverage_total":47},"commit":"b18a6c1","tree":"3b80bd9bf805"},{"iteration":3,"counts":{"stories_complete":2,"stories_total":16,"coverage_verified":6,"coverage_total":47},"commit":"5907a02","tree":"da39a3ee5e6b"}]}', NULL, '2026-08-16T17:14:05.037Z', '2026-08-16T17:44:14.369Z');
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05QK3RW4P1MV94JBZ2MZ5E6', '01M05NP14C3GCH372FM6NN2T5S', 'epic', 1, 'The cursor in the row''s own colour', 'pending', NULL, 0, 0);
...
INSERT INTO "task" ("id", "story_id", "number", "title", "description", "status", "status_note", "position") VALUES ('01M05QND4NDSPA598SDG2VEZ4D', '01M05QK3RW4P1MV94JBZ2MZ5E6', 1, 'Port InverseOptionList from the CPM board', 'The render_line override that repaints the highlighted strip in the row''s own colour, blended toward the background. Addresses the cursor''s appearance only — the row''s content composition belongs to story 2.', 'pending', NULL, 0);
