...
INSERT INTO "requirement" ("id", "spec_id", "spec_kind", "label", "class", "moscow", "exclusion", "parent_id", "text", "position", "coverage_claimed_at", "coverage_claim_hash") VALUES ('01M05JW91578GQ942N25MEHN7Y', '01M05J7VD7PWH32KWMND9MGHMN', 'spec', 'FR1', 'functional', 'must', NULL, NULL, 'Every key the CPM board binds carries the same meaning on the DPM board: `r` refreshes, `R` clears the cache, `a` registers a project, `x` unregisters the highlighted one, `z` shows or hides retired work, and the eight already shared — `q`, `l`, `o`, `t`, `c`, `space`, `←` and `→` — keep theirs. A capability the DPM board reaches only through the command palette today gains its CPM key.', 0, NULL, NULL);
INSERT INTO "requirement" ("id", "spec_id", "spec_kind", "label", "class", "moscow", "exclusion", "parent_id", "text", "position", "coverage_claimed_at", "coverage_claim_hash") VALUES ('01M05JWBSBWAGG1996DS44GNY8', '01M05J7VD7PWH32KWMND9MGHMN', 'spec', 'FR2', 'functional', 'must', NULL, NULL, 'Retired work is hidden when the board opens and `z` toggles it, where retired means `complete` together with the two states `status_model.RETIRED` already names — `superseded` and `withdrawn`. Each press says which way it went, as the CPM board''s does.', 1, NULL, NULL);
INSERT INTO "requirement" ("id", "spec_id", "spec_kind", "label", "class", "moscow", "exclusion", "parent_id", "text", "position", "coverage_claimed_at", "coverage_claim_hash") VALUES ('01M05JWDT6D746WHHMYMX25W99', '01M05J7VD7PWH32KWMND9MGHMN', 'spec', 'FR3', 'functional', 'must', NULL, NULL, 'Every capability the DPM board has and the CPM board lacks is bound to a key that collides with nothing in the CPM map. The forced re-read gives up `R` and takes `ctrl+r`; search and coverage gaps keep `ctrl+f` and `ctrl+g`.', 2, NULL, NULL);
...
INSERT INTO "requirement" ("id", "spec_id", "spec_kind", "label", "class", "moscow", "exclusion", "parent_id", "text", "position", "coverage_claimed_at", "coverage_claim_hash") VALUES ('01M05JWTJ2VA95F698PF5AJ2JH', '01M05J7VD7PWH32KWMND9MGHMN', 'spec', 'FR7', 'functional', 'should', NULL, NULL, 'The footer labels and the command-palette entries describe the keys as they stand after FR1 and FR3, and use the CPM board''s wording wherever the action is the same one.', 7, NULL, NULL);
INSERT INTO "requirement" ("id", "spec_id", "spec_kind", "label", "class", "moscow", "exclusion", "parent_id", "text", "position", "coverage_claimed_at", "coverage_claim_hash") VALUES ('01M05JWWMC9BJW4624YZVQTR9Q', '01M05J7VD7PWH32KWMND9MGHMN', 'spec', 'FR8', 'functional', 'must', NULL, NULL, 'The two boards are compared surface by surface beyond the four differences already established, and every further difference found is either closed or recorded as deliberate. A difference nobody has looked at is neither.', 8, NULL, NULL);
...
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCSR2WFK81RSHR2DWN57Q', '01M05JWWMC9BJW4624YZVQTR9Q', 'every further difference found is either closed or recorded as deliberate', '01M05PJ2Y927AH9W714D0MR3FA', 0, NULL, NULL);
INSERT INTO "coverage" ("id", "requirement_id", "spec_fragment", "story_criterion_id", "position", "verified_at", "binding_hash") VALUES ('01M05QCV0QPWC6YSP846RXNRZ8', '01M05JWWMC9BJW4624YZVQTR9Q', 'A difference nobody has looked at is neither.', '01M05PJ4EQQG7NG971CPK6VHZD', 1, NULL, NULL);
...
INSERT INTO "session" ("id", "skill", "phase", "state", "superseded_by", "created_at", "updated_at") VALUES ('d5d4f15e-4995-4cd2-84cc-1359f0c4bf1e', 'dpm:do', 'Epic 2 story 6 — sweep the interaction surfaces', '{"test_command":"uv run pytest (from dpm/tools/board)","framework":"none (plain Python + Textual)","refactoring":{"epic2-story1":"ran — registry_wiring extracted to tests/support/wiring.py","epic2-story2":"ran — toasts() extracted to pilot.py; show_everything() added","epic2-story3":"ran — surveyed() and registered() moved into wiring.py","epic2-story4":"ran — binding_tuples() extracted in key_maps.py; footer() added to pilot.py","epic2-story5":"ran — disagreement_report() extracted so the mutation control reads the message the suite prints; readable() gates every source read"}}', NULL, '2026-08-16T14:14:23.386Z', '2026-08-16T18:29:46.466Z');
...
INSERT INTO "document" ("id", "kind", "numbering", "number", "sequence", "slug", "title", "status", "status_note", "parent_id", "parent_kind", "archived_at", "commit_sha", "created_at", "updated_at", "retro_waived_at", "retro_waived_reason") VALUES ('01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 'child', NULL, 2, 'key-map-and-guard', 'The key map and its guard', 'pending', NULL, '01M05J7VD7PWH32KWMND9MGHMN', 'spec', NULL, NULL, '2026-08-16T16:15:08.014Z', '2026-08-16T16:15:08.014Z', NULL, NULL);
...
INSERT INTO "story" ("id", "epic_id", "epic_kind", "number", "title", "status", "status_note", "position", "plan") VALUES ('01M05PHPG35ET1G8J5B9AYNHVT', '01M05NNZQE4VVEWMCXGMZ72YJ5', 'epic', 6, 'Sweep the interaction surfaces', 'pending', NULL, 5, 0);
